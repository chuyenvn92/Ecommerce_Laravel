      ...
      <div class="product_panel panel">
       <div class="featured_slider slider">
        ...
        <div class="featured_slider_item">
         <div class="border_active"></div>
         <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
          <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset( $trend->image_one )}}" alt="" style="height: 120px; width:140px;"></div>
          <div class="product_content">
           @if($trend->discount_price == null)
           <div class="product_price discount">{{ $trend->selling_price }}đ</div>
           @else
           <div class="product_price discount">{{ $trend->discount_price }}đ<span>{{ $trend->selling_price }}đ</span></div>
           @endif
           <div class="product_name">
      ...
      <div class="product_panel panel">
       <div class="featured_slider slider">
        ...
        <div class="featured_slider_item">
         <div class="border_active"></div>
         <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
          <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset( $best->image_one )}}" alt="" style="height: 120px; width:140px;"></div>
          <div class="product_content">
           @if($best->discount_price == null)
           <div class="product_price discount">{{ $best->selling_price }}đ</div>
           @else
           <div class="product_price discount">{{ $best->discount_price }}đ<span>{{ $best->selling_price }}đ</span></div>
           @endif
           <div class="product_name">
            <div><a href="product.html">{{ $best->product_name }}</a></div>
           </div>
           <div class="product_extras">
            <div class="product_color">
             <input type="radio" checked name="product_color" style="background:#b19c83">
