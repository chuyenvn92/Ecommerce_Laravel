  ...
  <div class="sl-pagebody">
    ...
    <div class="card pd-20 pd-sm-40">
      <h6 class="card-body-title">Blog Category List
        <a href="#" class="btn btn-sm btn-warning" style="float: right;" data-toggle="modal" data-target="#addCategory">Add New Blog</a>
      </h6>
        ...
        <table id="datatable1" class="table display responsive nowrap">
          <thead>
            <tr>
              ...
              <th class="wd-15p">Category Name VietName</th>
      ...
      <div class="modal-content tx-size-sm">
        ...
        <form action="{{ route('store.blog.category') }}" method="POST">
          ...
          <div class="modal-body pd-20">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Category Name VietNam</label>
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name Vietnam" name="category_name_vn">
            </div><!-- modal-body -->
